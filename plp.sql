...
insert into adminlogin values(1,'capstore','capstore@gmail.com','1234','9803538343');
...
insert into customer_orders values(1,'shoes',4,50,255000,'not delievered ');
insert into customer_orders values(1,'shoes',2,50,55000);
insert into customer_orders(customer_id,product_name,order_id,quantity,amount) values(1,'shoes',8,50,255000);